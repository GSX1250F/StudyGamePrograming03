...
BackGround::BackGround(Game* game) :Actor(game)
{
	...
	bgactor->SetPosition(Vector2(0.0f, GetGame()->mWindowHeight * 0.5f));
	...
	//2‚Â–Ú‚Ì”wŒi
	bgactor = new Actor(GetGame());
	bgactor->SetPosition(Vector2(GetGame()->mWindowWidth, GetGame()->mWindowHeight * 0.5f));
